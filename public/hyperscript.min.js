...
// src/public/hyperscript.min.js
var require_hyperscript_min = __commonJS((exports, module) => {
  (function(e, t) {
    const r = t(e);
    ...
    class o {
      ...
      beepValueToConsole(e2, t2, r2) {
        if (this.triggerEvent(e2, "hyperscript:beep", {
          element: e2,
          expression: t2,
          value: r2
        })) {
    ...
    function T(t2) {
      ...
      t2.addFeature("def", function(e2, t3, r3) {
        ...
        var m2 = {
          displayName: o2 + "(" + s3.map(function(e3) {
            return e3.value;
          }).join(", ") + ")",
          name: o2,
          args: s3,
      ...
      t2.addGrammarElement("jsBody", function(e2, t3, r3) {
        ...
        return {
          type: "jsBody",
          exposedFunctionNames: a3,
          jsSource: r3.source.substring(n2, l3)
        };
      });
      t2.addFeature("js", function(t3, r3, n2) {
        ...
        return {
          jsSource: a3,
          function: o2,
          exposedFunctionNames: i2.exposedFunctionNames,
          install: function() {
            Object.assign(e, o2());
          }
        };
        ...
        if (r3.matchToken("for")) {
          ...
          do {
            ...
            if (a3.type === "NUMBER" || a3.type === "L_PAREN") {
              ...
              i2.push({
                name: e2.requireElement("dotOrColonPath", r3, "Expected event name").evaluate(),
                args: v2(r3)
              });
            }
          } while (r3.matchToken("or"));
      ...
      t2.addGrammarElement("pseudoCommand", function(e2, t3, r3) {
        ...
        if (s3) {
          u3 = {
            type: "pseudoCommand",
            root: s3,
            argExressions: o2.argExressions,
            args: [s3, o2.argExressions],
            op: function(e3, r4, n3) {
              t3.nullCheck(r4, s3);
    ...
    function y(e2) {
      ...
      e2.addCommand("toggle", function(e3, t3, r2) {
        if (r2.matchToken("toggle")) {
          ...
          var d2 = {
            ...
            args: [s2, p2, h2, v2, l2, c2, m2],
            op: function(e4, r3, n4, i3, a4, o4, s3, u3) {
              if (n4) {
      ...
      e2.addCommand("transition", function(e3, t3, n3) {
        if (n3.matchToken("transition")) {
          ...
          var m2 = {
            to: u2,
            args: [i3, a3, s2, u2, f2, c2],
            op: function(e4, n4, a4, o3, s3, u3, l3) {
              t3.nullCheck(n4, i3);
              var c3 = [];
              t3.implicitLoop(n4, function(e5) {
        ...
        return {
          ...
          op: function(e4, r3) {
            ...
            var o3 = {
              top: r3.scrollTop,
              left: r3.scrollLeft,
              topMax: r3.scrollTopMax,
              leftMax: r3.scrollLeftMax,
              height: r3.scrollHeight,
              width: r3.scrollWidth
            };
            e4.result = {
              x: a3.x,
              y: a3.y,
              ...
              scrollLeft: o3.left,
              scrollTop: o3.top,
              scrollLeftMax: o3.leftMax,
              scrollTopMax: o3.topMax,
              scrollWidth: o3.width,
              scrollHeight: o3.height,
              scroll: o3
            };
...
export default require_hyperscript_min();
