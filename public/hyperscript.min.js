      ...
      while (o < a.length) {
        if (
          ...
          if (n.isWhitespace(S())) {
            ...
            r.push(y());
          } else if (n.isAlpha(S()) || (!f() && n.isIdentifierChar(S()))) {
            r.push(x());
          } else if (n.isNumeric(S())) {
            r.push(g());
          } else if (!f() && (S() === '"' || S() === "`")) {
            r.push(w());
          } else if (!f() && S() === "'") {
        ...
        install: function (e, r) {
          for (const r of L.events) {
            ...
            if (r.elsewhere) {
              ...
              n = r.from.evaluate(t.makeContext(e, L, e, null));
            } else {
              n = [e];
            }
            ...
            if (n) {
              ...
              t.implicitLoop(r, function (e) {
                ...
                if (l) {
                  ...
                  n.style.top = t.x + r + "px";
                  n.style.left = t.y + r + "px";
                  n.style.height = t.height + 2 * r + "px";
                  n.style.width = t.width + 2 * r + "px";
