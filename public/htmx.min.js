  ...
  (function(e, t) {
    ...
    return function() {
      ...
      function rr(e2, t2) {
        if (e2.willValidate) {
          ...
          if (!e2.checkValidity()) {
            t2.push({
              elt: e2,
              message: e2.validationMessage,
              validity: e2.validity
            });
            fe(e2, "htmx:validation:failed", {
              message: e2.validationMessage,
              validity: e2.validity
            });
          }
      ...
      function fr(e2, t2) {
        ...
        var n2 = {
          swapStyle: ie(e2).boosted ? "innerHTML" : Y.config.defaultSwapStyle,
      ...
      function wr(e2, t2, r2) {
        ...
        if (r2) {
          if (r2 instanceof Element || L(r2, "String")) {
            return ce(e2, t2, null, null, {
              targetOverride: s(r2),
              returnPromise: true
            });
          } else {
            return ce(e2, t2, s(r2.source), r2.event, {
              handler: r2.handler,
              headers: r2.headers,
              values: r2.values,
              targetOverride: s(r2.target),
      ...
      function ce(e2, t2, n2, r2, i2, M2) {
        ...
        var H2 = {
          ...
          useUrlParams: q2,
          parameters: R2,
          unfilteredParameters: z2,
          headers: E2,
          target: l2,
          verb: e2,
          errors: C2,
          withCredentials: i2.credentials || O2.credentials || Y.config.withCredentials,
          timeout: i2.timeout || O2.timeout || Y.config.timeout,
          path: t2,
          triggeringEvent: r2
        };
        ...
        var I2 = {
          ...
          etc: i2,
          boosted: W2,
          pathInfo: { requestPath: t2, finalRequestPath: A2, anchor: L2 }
        };
        b2.onload = function() {
          try {
            var e3 = Sr(n2);
      ...
      function Tr(l2, u2) {
        ...
        var n2 = R(f2, /HX-Refresh:/i) && f2.getResponseHeader("HX-Refresh") === "true";
          ...
          var x2 = function() {
            try {
              ...
              try {
                t3 = {
                  elt: e3,
                  start: e3 ? e3.selectionStart : null,
                  end: e3 ? e3.selectionEnd : null
                };
              } catch (e4) {
              }
              var r3;
              ...
              if (t3.elt && !oe(t3.elt) && Q(t3.elt, "id")) {
                ...
                var a3 = {
                  preventScroll: h2.focusScroll !== undefined ? !h2.focusScroll : !Y.config.defaultFocusScroll
                };
                if (i3) {
        ...
        if (a2) {
          ue(l2, "htmx:responseError", se({
            error: "Response Status Error Code " + f2.status + " from " + u2.pathInfo.requestPath
          }, u2));
        }
      }
      var Rr = {};
...
export default require_htmx_min();
